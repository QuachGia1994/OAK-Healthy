...
- P9.4 Coach Workspace 3.0 is implemented locally: client drill-down, same-client current-vs-previous 7/30/90-day reports, filters, local routine check-ins and a renderer-neutral report document boundary.
- P9.5 Activation & Retention 2.0 is implemented locally: first-value milestones, actionable empty/recovery states, pressure-free recent-rhythm feedback and aggregate-only consent-gated activation telemetry.
