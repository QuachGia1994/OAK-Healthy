...
def main() -> None:
    ...
    daemon_jvm = read("Android/gradle/gradle-daemon-jvm.properties")
    ...
    android_build = read(".github/workflows/android-build.yml")
    baseline_workflow = read(".github/workflows/android-baselineprofile.yml")
    ...
    require("toolchainVendor=JETBRAINS" in daemon_jvm and "toolchainVersion=21" in daemon_jvm, "Gradle daemon pins JetBrains JDK 21")
    require(android_build.count("Setup JetBrains JDK 21") >= 2 and "distribution: 'jetbrains'" in android_build and "java-version: '21'" in android_build, "Android build/test CI matches daemon JDK")
    require("Setup JetBrains JDK 21" in quality and "distribution: 'jetbrains'" in quality and "java-version: '21'" in quality, "Android quality CI matches daemon JDK")
    require("Setup JetBrains JDK 21" in release and "distribution: 'jetbrains'" in release and "java-version: '21'" in release, "Android release CI matches daemon JDK")
    require("Setup JetBrains JDK 21" in baseline_workflow and 'distribution: "jetbrains"' in baseline_workflow and 'java-version: "21"' in baseline_workflow, "Android baseline-profile CI matches daemon JDK")
