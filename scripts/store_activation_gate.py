...
def main() -> None:
    ...
    require(android_build.count("Setup JetBrains JDK 21") >= 2 and "distribution: 'jetbrains'" in android_build and "java-version: '21'" in android_build, "Android build/test CI uses JetBrains JDK 21")
    require("Setup JetBrains JDK 21" in quality and "distribution: 'jetbrains'" in quality and "java-version: '21'" in quality, "Android quality CI uses JetBrains JDK 21")
    require("Setup JetBrains JDK 21" in release and "distribution: 'jetbrains'" in release and "java-version: '21'" in release, "Android release CI uses JetBrains JDK 21")
    require("Setup JetBrains JDK 21" in baseline_workflow and 'distribution: "jetbrains"' in baseline_workflow and 'java-version: "21"' in baseline_workflow, "Android baseline-profile CI uses JetBrains JDK 21")
