...
interface SupplementRepository {
    ...
    fun getSupplementsWithTakenToday(clientId: String, startOfDay: Long, endExclusive: Long): Flow<List<UserSupplementTakenToday>>
    ...
    fun getRecordsByDateRange(clientId: String, startDate: Long, endExclusive: Long): Flow<List<IntakeRecord>>
